...
#define INTERNAL_MPT_DELAYED_MULTI_CONCAT(A, ...) INTERNAL_MPT_MULTI_CONCAT(A, __VA_ARGS__)
#define INTERNAL_MPT_DELAYED_MULTI_CONCAT2(A, ...) INTERNAL_MPT_MULTI_CONCAT2(A, __VA_ARGS__)
#define INTERNAL_MPT_DELAYED_MULTI_CONCAT3(A, ...) INTERNAL_MPT_MULTI_CONCAT3(A, __VA_ARGS__)
#define INTERNAL_MPT_DELAYED_MULTI_CONCAT4(A, ...) INTERNAL_MPT_MULTI_CONCAT4(A, __VA_ARGS__)
#define INTERNAL_MPT_DELAYED_MULTI_CONCAT5(A, ...) INTERNAL_MPT_MULTI_CONCAT5(A, __VA_ARGS__)
#define INTERNAL_MPT_DELAYED_MULTI_CONCAT6(A, ...) INTERNAL_MPT_MULTI_CONCAT6(A, __VA_ARGS__)
#define INTERNAL_MPT_DELAYED_MULTI_CONCAT7(A, ...) INTERNAL_MPT_MULTI_CONCAT7(A, __VA_ARGS__)
#define INTERNAL_MPT_DELAYED_MULTI_CONCAT8(A, ...) INTERNAL_MPT_MULTI_CONCAT8(A, __VA_ARGS__)
#define INTERNAL_MPT_DELAYED_MULTI_CONCAT9(A, ...) INTERNAL_MPT_MULTI_CONCAT9(A, __VA_ARGS__)
#define INTERNAL_MPT_DELAYED_MULTI_CONCAT10(A, ...) INTERNAL_MPT_MULTI_CONCAT10(A, __VA_ARGS__)
#define INTERNAL_MPT_DELAYED_MULTI_CONCAT11(A, ...) INTERNAL_MPT_MULTI_CONCAT11(A, __VA_ARGS__)
#define INTERNAL_MPT_DELAYED_MULTI_CONCAT12(A, ...) INTERNAL_MPT_MULTI_CONCAT12(A, __VA_ARGS__)
#define INTERNAL_MPT_DELAYED_MULTI_CONCAT13(A, ...) INTERNAL_MPT_MULTI_CONCAT13(A, __VA_ARGS__)
#define INTERNAL_MPT_DELAYED_MULTI_CONCAT14(A, ...) INTERNAL_MPT_MULTI_CONCAT14(A, __VA_ARGS__)
#define INTERNAL_MPT_DELAYED_MULTI_CONCAT15(A, ...) INTERNAL_MPT_MULTI_CONCAT15(A, __VA_ARGS__)
#define INTERNAL_MPT_DELAYED_MULTI_CONCAT16(A, ...) INTERNAL_MPT_MULTI_CONCAT16(A, __VA_ARGS__)
#define INTERNAL_MPT_DELAYED_MULTI_CONCAT17(A, ...) INTERNAL_MPT_MULTI_CONCAT17(A, __VA_ARGS__)
#define INTERNAL_MPT_DELAYED_MULTI_CONCAT18(A, ...) INTERNAL_MPT_MULTI_CONCAT18(A, __VA_ARGS__)
#define INTERNAL_MPT_DELAYED_MULTI_CONCAT19(A, ...) INTERNAL_MPT_MULTI_CONCAT19(A, __VA_ARGS__)
#define INTERNAL_MPT_DELAYED_MULTI_CONCAT20(A, ...) INTERNAL_MPT_MULTI_CONCAT20(A, __VA_ARGS__)
